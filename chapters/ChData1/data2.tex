...
import pandas as pdfrom matplotlib import pyplot as pltdf = pd.read_csv('covid_2.csv')print(df.to_string())data11=df.get('group')data21=df.get('group2')plt.plot(data11)plt.plot(data21)plt.show()
File: 
...
(i) df.describe() #this might be of use https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.describe.html

(ii) df.pct_change() #this might be of use https://www.tutorialspoint.com/python_pandas/python_pandas_statistical_functions.htm

(iii) df.corr() #this might be of use https://www.tutorialspoint.com/python_pandas/python_pandas_statistical_functions.htm
